            ...
            <CardContent>
              <div className="flex justify-items-center">
                ...
                <div className="m-auto ">
                  <Card className="bg-hwachang-main mx-2 shadow-hwachang-main">
                  ...
                  <p className="text-xs text-hwachang-accentmain font-semibold pt-2">NPS란 ?</p>
                  <p className="text-xs text-hwachang-accentmain">
        ...
        <div className="hidden xl:grid gap-12 grid-rows-3">
          ...
          <Card className="border-none row-span-1 shadow-banker-card">
            ...
            <CardContent className="text-2xl font-semibold text-hwachang-green1 flex justify-center items-end">
              <p className="text-7xl font-bold text-hwachang-main">{npsPromoter}명</p>이
            </CardContent>
