...
export default function Home() {
  ...
  return (
    <main>
      <h1 className={` mb-4 text-xl md:text-2xl text-center`}>컴포넌트 예시</h1>
      <div className="text-center py-2">세로(격자)로 배치하기</div>
      <Card>
        <CardHeader className="text-center">dasd</CardHeader>
        <CardContent>sasa</CardContent>
      ...
      <div className={`grid gap-6 grid-cols-3 text-center`}>
        <Card>
          <CardHeader>
            {" "}
            <p className="text-xl">카드 헤더 제목이 보통 들어갑니다. 클래스 네임으로 위치 조정이 가능해요</p>{" "}
          </CardHeader>
          <CardContent>
            <div className="flex flex-col justify-center items-center">
              <HouseEmoji heignt={200} width={200} />
              모든 JSX.Elemetnt가 다 이 카드 컨텐츠 섹션안에 들어올 수 있습니다. div, form, 버튼 등 모두 다요
            </div>
          </CardContent>
          <CardFooter className="justify-center">
            <AchromaticButton>
              <Link href="/customer/main/enterance?isIndividual=true">상담하러 가기</Link>
            </AchromaticButton>
          </CardFooter>
        </Card>
        <Card className="bg-red-100">
          ...
          <CardHeader>
            {" "}
            <p className="text-xl">커스텀 카드 컴포넌트</p>{" "}
          </CardHeader>
          <CardContent>
            <div className="flex flex-col justify-center items-center ">
              ...
              <p>
                <strong>클래스 네임을 이용하여 색과 크기도 바꿀 수 있습니다.</strong>
              </p>
            </div>
          </CardContent>
          <CardFooter className="justify-center">
            <AchromaticButton>
              <Link href="/customer/main/enterance?isIndividual=false">상담하러 가기</Link>
            </AchromaticButton>
          </CardFooter>
        </Card>
        <Card>
