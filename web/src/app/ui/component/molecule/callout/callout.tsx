...
const alertVariants = cva(
  'flex items-center justify-center relative w-full rounded-lg bg-slate-200 px-4 py-2 text-sm  [&>svg]:text-slate-950 dark:bg-slate-800 dark:[&>svg]:text-slate-50',
  {
    variants: {
      variant: {
        default:
          'bg-emerald-300 text-white dark:bg-green-500 [&>svg]:text-white dark:border-green-900/50 dark:text-green-900 dark:dark:border-green-900 dark:[&>svg]:text-green-900',
        destructive:
